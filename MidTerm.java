...
public class MidTerm extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    //Define objects to be used
    private EditText itemET;
    private Button btn;
    private Button backBtnMid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backBtnMid = findViewById(R.id.backButtonMid);
        ...
        backBtnMid.setOnClickListener(this);
